...
public class Info {
    ...
    public static final String sVersionName = "v0.9.7";
    public static final String sVersionNum = "0970";
    ...
    */
    ...
    public static final String smtpUser = "7a718d8a0c368f";
    public static final String smtpPasswd = "9c05127602ad75";
    public static final String smtpSetFrom = "sfw.veontec@support.com";
